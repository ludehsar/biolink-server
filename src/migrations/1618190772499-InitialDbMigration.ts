...
export class InitialDbMigration1618190772499 implements MigrationInterface {
    name = 'InitialDbMigration1618190772499'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "emailVerifiedAt" date, "emailActivationCode" character varying, "encryptedPassword" character varying NOT NULL, "forgotPasswordCode" character varying, "name" character varying, "userRole" "user_userrole_enum" NOT NULL DEFAULT 'User', "billing" json, "tokenCode" character varying, "authenticatorSecret" character varying, "facebookId" character varying, "activeStatus" "user_activestatus_enum" NOT NULL DEFAULT 'Inactive', "planExpirationDate" date, "planTrialDone" boolean NOT NULL DEFAULT false, "paymentSubscriptionId" character varying, "language" character varying, "timezone" character varying, "lastIPAddress" character varying, "lastUserAgent" character varying, "country" character varying, "totalLogin" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "planId" integer, "categoryId" integer, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "UQ_67f5b68a05c3ded5f1123742d4e" UNIQUE ("emailActivationCode"), CONSTRAINT "UQ_7aa69905302b42689211f9bb91e" UNIQUE ("forgotPasswordCode"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
